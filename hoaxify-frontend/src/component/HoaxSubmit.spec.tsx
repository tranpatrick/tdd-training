...
import {fireEvent, queryByTestId, render, waitFor, waitForElementToBeRemoved,} from '@testing-library/react';
...
describe('HoaxSubmit', () => {
    ...
    describe('Interactions', () => {
        ...
        const setupFocused = () => {
            ...
            textArea = rendered.container.querySelector('textarea') as HTMLTextAreaElement;
        ...
        it('calls postHoax with hoax request object when clicking Hoaxify', () => {
            ...
            const hoaxifyButton = queryByText('Hoaxify') as HTMLButtonElement;

            jest.spyOn(apiCalls, 'postHoax').mockResolvedValue({});
        ...
        it('disables Hoaxify button when there is postHoax api call', async () => {
            ...
            jest.spyOn(apiCalls, 'postHoax').mockImplementation(mockFunction);
        ...
        it('displays spinner when there is postHoax api call', async () => {
            const {queryByText, queryByTestId} = setupFocused();
            fireEvent.change(textArea, {target: {value: 'Test hoax content'}});
            ...
            expect(queryByTestId('spinner-span')).toBeInTheDocument();
        });
