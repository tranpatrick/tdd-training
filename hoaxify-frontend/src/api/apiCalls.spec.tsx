...
describe('apiCalls', () => {
    ...
    describe('listUser', () => {
        it('calls /api/v1.0/users?page=0&size=3 when no param provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
            apiCalls.listUsers();
            expect(mockListUsers).toBeCalledWith('/api/v1.0/users?page=0&size=3');
        });

        it('calls /api/v1.0/users?page=5&size=10 when corresponding params provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
            apiCalls.listUsers({ page: 5, size: 10 });
            expect(mockListUsers).toBeCalledWith('/api/v1.0/users?page=5&size=10');
        });

        it('calls /api/v1.0/users?page=5&size=3 when only page param provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
            apiCalls.listUsers({ page: 5 });
            expect(mockListUsers).toBeCalledWith('/api/v1.0/users?page=5&size=3');
        });

        it('calls /api/v1.0/users?page=0&size=5 when only size param provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
            apiCalls.listUsers({ size: 5 });
            expect(mockListUsers).toBeCalledWith('/api/v1.0/users?page=0&size=5');
        });
    });
    ...
    //         expect(mockGetHoaxes).toBeCalledWith(
    //             '/api/v1.0/hoaxes/5?direction=before&page=0&size=5&sort=id,desc'
    //         );
    //     });
    //     it('calls /api/v1.0/users/user3/hoaxes/5?direction=before&page=0&size=5&sort=id,desc when hoax id and username param provided', () => {
    //         const mockGetHoaxes = jest.fn();
    //         axios.get = mockGetHoaxes;
    //         apiCalls.loadOldHoaxes(5, 'user3');
    //         expect(mockGetHoaxes).toBeCalledWith(
    //             '/api/v1.0/users/user3/hoaxes/5?direction=before&page=0&size=5&sort=id,desc'
    //         );
    //     });
    // });
    ...
    //         expect(mockGetHoaxes).toBeCalledWith(
    //             '/api/v1.0/hoaxes/5?direction=after&sort=id,desc'
    //         );
    //     });
    //     it('calls /api/v1.0/users/user3/hoaxes/5?direction=after&sort=id,desc when hoax id and username param provided', () => {
    //         const mockGetHoaxes = jest.fn();
    //         axios.get = mockGetHoaxes;
    //         apiCalls.loadNewHoaxes(5, 'user3');
    //         expect(mockGetHoaxes).toBeCalledWith(
    //             '/api/v1.0/users/user3/hoaxes/5?direction=after&sort=id,desc'
    //         );
    //     });
    // });
    ...
    //         expect(mockGetHoaxes).toBeCalledWith(
    //             '/api/v1.0/hoaxes/5?direction=after&count=true'
    //         );
    //     });
    //     it('calls /api/v1.0/users/user3/hoaxes/5?direction=after&count=true when hoax id and username param provided', () => {
    //         const mockGetHoaxes = jest.fn();
    //         axios.get = mockGetHoaxes;
    //         apiCalls.loadNewHoaxCount(5, 'user3');
    //         expect(mockGetHoaxes).toBeCalledWith(
    //             '/api/v1.0/users/user3/hoaxes/5?direction=after&count=true'
    //         );
    //     });
    // });
    ...
    //         expect(path).toBe('/api/v1.0/hoaxes/upload');
    //     });
    // });
    // describe('deleteHoax', () => {
    //     it('calls /api/v1.0/hoaxes/5 when hoax id param provided as 5', () => {
    //         const mockDelete = jest.fn();
    //         axios.delete = mockDelete;
    //         apiCalls.deleteHoax(5);
    //         const path = mockDelete.mock.calls[0][0];
    //         expect(path).toBe('/api/v1.0/hoaxes/5');
    //     });
    // });
})